...
class GuidelineHandler {
	...
	movingGuidelines = (target: FabricObject) => {
		...
		for (let i = canvasObjects.length; i--; ) {
			...
			// console.log(activeObjectLeft);
			// console.log(activeObjectWidth);
			// console.log(objectWidth/2);
			// this.isInRange(objectLeft + objectWidth / 2, activeObjectLeft + activeObjectWidth / 2)
			//中间线
