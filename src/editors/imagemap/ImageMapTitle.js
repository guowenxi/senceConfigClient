...
class ImageMapTitle extends Component {
	render() {
		const { title, content, action, children ,component } = this.props;
		return (
			children || (
				<Flex className="rde-content-layout-title" alignItems="center" flexWrap="wrap">
					<Flex.Item flex="0 1 auto" style={{minWidth:'250px',maxWidth:'250px'}}>
						<Flex
					...
					<Flex.Item flex="0 1 auto">
						<Flex
							className="rde-content-layout-title-title componentBox"
							justifyContent="flex-start"
							alignItems="center"
						>
							{component}
