...
class ImageMapItems extends Component {
	...
	renderItems = items => {
		...
		return <Flex flexWrap="wrap" flexDirection="column" style={{ width: '100%' }}>
	...
	renderItem = (item, centered) =>
		{
			...
			>
				<img src={item.option.code.fixedSrc} ></img>
				...
				<Flex flex="1" flexDirection="column" style={{ height: '100%' }}>
					{/* <Flex justifyContent="center" alignItems="center" style={{ height: 40 }}>
						<CommonButton
							...
							style={{ margin: '0 4px',color:'#fff' }}
							onClick={this.handlers.onCollapse}
						/>
					</Flex> */}
					<div className='equipment-title'>设备列表</div>
					<Scrollbar>
